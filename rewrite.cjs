...
${col3Content}
    ...
    // Also extract the MILESTONE / AREA block separately if it's there
    // It is normally located at: {/* ─── V5: MILESTONE / AREA ─── */} until `{/* ─── PLANIFICACIÓN ─── */}`
    // But since `PEER REVIEW` goes down to PLANIFICACIÓN, wait, what about the sections inside it?
    // Let's print something to see what we actually extracted.
