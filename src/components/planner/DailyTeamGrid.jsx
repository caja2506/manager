...
const TIME_BANDS = [
    { id: 'desayuno', label: '🍳 Desayuno', start: 8,    end: 8.5,  bg: 'rgba(251,191,36,0.10)', border: 'rgba(245,158,11,0.40)', text: '#fcd34d' },
    { id: 'almuerzo', label: '🍽 Almuerzo', start: 12,   end: 13,   bg: 'rgba(52,211,153,0.10)',  border: 'rgba(16,185,129,0.35)',  text: '#fde68a' },
    { id: 'cafe',     label: '☕ Café',      start: 15.5, end: 16,   bg: 'rgba(249,115,22,0.10)',  border: 'rgba(234,88,12,0.35)',   text: '#fdba74' },
];
