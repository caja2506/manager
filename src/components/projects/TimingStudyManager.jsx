...
export default function TimingStudyManager({ projectId, canEdit = false, userId = null }) {
    ...
    const handleConfigChanges = useCallback((updates) => {
        setStudyConfig(prev => {
            ...
            // Caso A: Se cambió el OEE (oeePenalty)
            ...
            // Caso B: Se cambió la disponibilidad (availability)
            ...
            // Caso C: Se cambió la eficiencia (efficiency)
            ...
            // Caso D: Se cambió el rendimiento (yield)
    ...
    const handleSaveStandards = async () => {
        ...
        try {
            ...
            console.warn('[TimingStudyManager] Falló guardado en Supabase, guardando en localStorage como fallback:', err.message);
    ...
    const handleUpdateStep = async (stepId, updates) => {
        ...
        try {
            ...
            // Campos que afectan la duración sugerida (solo recalcular si el drawer NO envió durationMs)
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center py-16 bg-slate-900/40 rounded-2xl border border-slate-800/80">
                ...
                <p className="text-sm text-slate-400">Cargando módulo de estudio de tiempos...</p>
            </div>
        );
    }
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 flex flex-col justify-between">
                                                    <div>
                                                        ...
                                                        <span className="text-[10px] text-slate-400 block font-mono mt-0.5" title="Capacidad teórica bruta al 100% de OEE">
                        ...
                        <div className="bg-slate-900/70 rounded-xl border border-slate-800 overflow-hidden">
                            ...
                            >
                                <span className="text-xs font-bold text-slate-300 uppercase tracking-wider flex items-center gap-2">
                                    ...
                                    Ajustes Estándar de la Plataforma (Sólo Lectura)
                                </span>
                                <span className="text-xs text-cyan-400 font-bold">
                            ...
                            {steps.length === 0 ? (
                                <div className="p-12 text-center">
                                    ...
                                    <p className="text-xs text-slate-500 max-w-xs mx-auto mb-6">
                                        Agrega pasos individuales o impórtalos automáticamente desde las estaciones del proyecto.
                                    </p>
                                    {canEdit && stations.length > 0 && (
                                        <div className="flex justify-center gap-3">
                                            <button
