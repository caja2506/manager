...
import { updateTaskStatus, updateTask } from './taskService.firebase';
...
export async function createDelay(data, userId) {
    ...
    if (data.taskId) {
        // Set blockedReason + responsible person first (non-protected fields, direct write OK)
        const blockFields = {
        ...
        try {
            ...
            // Log the status change so ActivityPage KPIs pick it up
